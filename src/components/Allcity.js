...
export default function Allcity() {
    const cities = [
        ...
        { url: "https://fondosmil.com/fondo/60652.jpg" , city: "Roma", description:"Rome is an Italian city, capital of the Lazio region and of Italy. With a population of 2,815,951 inhabitants, it is the most populous municipality in Italy and the third most populous city in the European Union.​"},
        { url: "https://w0.peakpx.com/wallpaper/647/346/HD-wallpaper-venice-italy-landscape-graphy.jpg" , city: "Venecia", description:"Located in a marshy lagoon in the Adriatic Sea, between the mouths of the Po and Piave rivers, the city of Venice is made up of 120 small islands, connected to each other by hundreds of bridges, rivers and canals."},
        { url: "https://p4.wallpaperbetter.com/wallpaper/221/423/653/cities-brussels-belgium-grand-palace-wallpaper-preview.jpg" , city: "Bruselas", description:"Located in a marshy lagoon in the Adriatic Sea, between the mouths of the Po and Piave rivers, the city of Venice is made up of 120 small islands, connected to each other by hundreds of bridges, rivers and canals."},
        ...
        { url: "https://fondosmil.com/fondo/15090.jpg" , city: "Londres", description:"This emblematic city is located in the southeast of England, right on the two banks of the River Thames. Founded as Londinium in the year 43, it is one of the most populated cities in Europe, and we would say that in the world."},
